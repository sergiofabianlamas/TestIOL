...
namespace CodingChallenge.Data.Tests
{
    ...
    public class DataTests
    {
        ...
        /// <summary>
        /// nuevo caso de prueba de NO exito (ya que no hay error), donde se controla el funcionamiento de la nueva clase para la nueva figura.
        /// </summary>
        [TestCase]
        public void TestTrapecio()
        {
            ...
            prueba.LadoAltura = 2; prueba.LadoBaseA = 3; prueba.LadoBaseB = 4; prueba.Altura = 1;

            Assert.AreEqual("<h1>Reporte de Formas</h1> Trapecio  |  Area 3,5 |  Perimetro 11", prueba.Imprimir(1));
        }
